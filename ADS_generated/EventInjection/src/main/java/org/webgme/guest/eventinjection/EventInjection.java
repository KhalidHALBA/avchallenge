...
//	return   EventInjectionparameter.EventInjectionSPNs = EventInjectionparameter.Peak_Voltage  + " " + EventInjectionparameter.Peak_Current  + " " +EventInjectionparameter.State_Of_Charge  + " " +EventInjectionparameter.State_Of_Health  + " " +EventInjectionparameter.Remaining_Capacity + " " + EventInjectionparameter.Max_Temperature + " " + EventInjectionparameter.Min_Temperature  + " " +EventInjectionparameter.Peak_Current_Limit;
