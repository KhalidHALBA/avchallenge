...
// 					      
    ...
    {
 	//  return UCEFGatewayparameter.UCEFGatewaySPNs= UCEFGatewayparameter.Motor_Operating_Mode + " " + UCEFGatewayparameter.Motor_Torque_cmd + " " +UCEFGatewayparameter.Motor_Speed + " " + UCEFGatewayparameter.Volt_Cmd+ " " + UCEFGatewayparameter.Contactor_Override_Commands+ " " + UCEFGatewayparameter.Battery_Commands+ " " + UCEFGatewayparameter.Torque_Commands +" "+UCEFGatewayparameter.InverterCoolingAndHeatingCommands ;
   	  return UCEFGatewayparameter.UCEFGatewaySPNs= UCEFGatewayparameter.Motor_Speed + " " + UCEFGatewayparameter.Motor_Torque_cmd ;
    }
...
//    	      	   Build_and_Send_CAN_Frame( UCEFGatewayparameter.UCEFGatewayPGN, Build_SPN());
    ...
    public static void main(String[] args) {
        try {
            ...
            UCEFGatewayConfig federateConfig =
                federateConfigParser.parseArgs(args, UCEFGatewayConfig.class);
            UCEFGateway federate =
                new UCEFGateway(federateConfig);
            federate.execute();
            log.info("Done.");
            System.exit(0);
        }
