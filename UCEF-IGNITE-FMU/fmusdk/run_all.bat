...
echo -----------------------------------------------------------
call fmusim me10 fmu10\fmu\me\%x64%drivecycle.fmu 4 0.01 0 c %1
move /Y result.csv result_me10%x64NAME%_drivecycle.csv

echo -----------------------------------------------------------
call fmusim cs10 fmu10\fmu\cs\%x64%drivecycle.fmu 4 0.01 0 c %1
move /Y result.csv result_cs10%x64NAME%_drivecycle.csv
...
echo -----------------------------------------------------------
call fmusim me20 fmu20\fmu\me\%x64%drivecycle.fmu 4 0.01 0 c %1
move /Y result.csv result_me20%x64NAME%_drivecycle.csv

echo -----------------------------------------------------------
call fmusim cs20 fmu20\fmu\cs\%x64%drivecycle.fmu 4 0.01 0 c %1
move /Y result.csv result_cs20%x64NAME%_drivecycle.csv
