...
/**
* Implements ObjectRoot.DataRevisions
*/
public class DataRevisions extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the DataRevisions object class with default attribute values.
    */
    public DataRevisions() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the DataRevisions object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the DataRevisions object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.DataRevisions";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the DataRevisions object class.
    *
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.DataRevisions");
        _classNameClassMap.put("ObjectRoot.DataRevisions", DataRevisions.class);

        _datamemberClassNameSetMap.put("ObjectRoot.DataRevisions", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.DataRevisions", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.DataRevisions", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.DataRevisions", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.DataRevisions");
        ...
        _classNameHandleMap.put("ObjectRoot.DataRevisions", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.DataRevisions");
        _classHandleSimpleNameMap.put(get_handle(), "DataRevisions");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.DataRevisions.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.DataRevisions.Value", _Value_handle);
    ...
    /**
    * Publishes the DataRevisions object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.DataRevisions." + attributeName));
    ...
    /**
    * Unpublishes the DataRevisions object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the DataRevisions object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.DataRevisions." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the DataRevisions object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the DataRevisions object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the DataRevisions object class).
    ...
    */
    ...
    protected DataRevisions( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected DataRevisions( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the DataRevisions object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new DataRevisions object class instance
    */
    public DataRevisions( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #DataRevisions( ReflectedAttributes datamemberMap )}, except this
    * new DataRevisions object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new DataRevisions object class instance
    * @param logicalTime timestamp for this new DataRevisions object class
    * instance
    */
    public DataRevisions( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new DataRevisions object class instance that is a duplicate
    * of the instance referred to by DataRevisions_var.
    *
    * @param DataRevisions_var DataRevisions object class instance of which
    * this newly created DataRevisions object class instance will be a
    * duplicate
    */
    public DataRevisions( DataRevisions DataRevisions_var ) {
        super( DataRevisions_var );

        set_Protocol( DataRevisions_var.get_Protocol() );
        set_Value( DataRevisions_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof DataRevisions ) {
            DataRevisions data = (DataRevisions)object;
