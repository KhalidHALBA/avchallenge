...
/**
* Implements ObjectRoot.IniialData
*/
public class IniialData extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the IniialData object class with default attribute values.
    */
    public IniialData() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the IniialData object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the IniialData object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.IniialData";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the IniialData object class.
    *
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.IniialData");
        _classNameClassMap.put("ObjectRoot.IniialData", IniialData.class);

        _datamemberClassNameSetMap.put("ObjectRoot.IniialData", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.IniialData", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.IniialData", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.IniialData", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.IniialData");
        ...
        _classNameHandleMap.put("ObjectRoot.IniialData", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.IniialData");
        _classHandleSimpleNameMap.put(get_handle(), "IniialData");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.IniialData.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.IniialData.Value", _Value_handle);
    ...
    /**
    * Publishes the IniialData object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.IniialData." + attributeName));
    ...
    /**
    * Unpublishes the IniialData object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the IniialData object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.IniialData." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the IniialData object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the IniialData object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the IniialData object class).
    ...
    */
    ...
    protected IniialData( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected IniialData( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the IniialData object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new IniialData object class instance
    */
    public IniialData( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #IniialData( ReflectedAttributes datamemberMap )}, except this
    * new IniialData object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new IniialData object class instance
    * @param logicalTime timestamp for this new IniialData object class
    * instance
    */
    public IniialData( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new IniialData object class instance that is a duplicate
    * of the instance referred to by IniialData_var.
    *
    * @param IniialData_var IniialData object class instance of which
    * this newly created IniialData object class instance will be a
    * duplicate
    */
    public IniialData( IniialData IniialData_var ) {
        super( IniialData_var );

        set_Protocol( IniialData_var.get_Protocol() );
        set_Value( IniialData_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof IniialData ) {
            IniialData data = (IniialData)object;
