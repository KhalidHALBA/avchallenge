package org.webgme.guest.tripmanager.rti;
...
/**
* Implements ObjectRoot.TimeLocCommsSignals
*/
public class TimeLocCommsSignals extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the TimeLocCommsSignals object class with default attribute values.
    */
    public TimeLocCommsSignals() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the TimeLocCommsSignals object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the TimeLocCommsSignals object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.TimeLocCommsSignals";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the TimeLocCommsSignals object class.
    *
    * @return the name of this object class
    */
    public static String get_simple_class_name() {
        return "TimeLocCommsSignals";
    }
    ...
    * TimeLocCommsSignals object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.TimeLocCommsSignals");
        _classNameClassMap.put("ObjectRoot.TimeLocCommsSignals", TimeLocCommsSignals.class);

        _datamemberClassNameSetMap.put("ObjectRoot.TimeLocCommsSignals", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.TimeLocCommsSignals", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.TimeLocCommsSignals", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.TimeLocCommsSignals", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.TimeLocCommsSignals");
        ...
        _classNameHandleMap.put("ObjectRoot.TimeLocCommsSignals", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.TimeLocCommsSignals");
        _classHandleSimpleNameMap.put(get_handle(), "TimeLocCommsSignals");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.TimeLocCommsSignals.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.TimeLocCommsSignals.Value", _Value_handle);
    ...
    /**
    * Publishes the TimeLocCommsSignals object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.TimeLocCommsSignals." + attributeName));
    ...
    /**
    * Unpublishes the TimeLocCommsSignals object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the TimeLocCommsSignals object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.TimeLocCommsSignals." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the TimeLocCommsSignals object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the TimeLocCommsSignals object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the TimeLocCommsSignals object class).
    ...
    */
    ...
    protected TimeLocCommsSignals( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected TimeLocCommsSignals( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the TimeLocCommsSignals object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new TimeLocCommsSignals object class instance
    */
    public TimeLocCommsSignals( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #TimeLocCommsSignals( ReflectedAttributes datamemberMap )}, except this
    * new TimeLocCommsSignals object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new TimeLocCommsSignals object class instance
    * @param logicalTime timestamp for this new TimeLocCommsSignals object class
    * instance
    */
    public TimeLocCommsSignals( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new TimeLocCommsSignals object class instance that is a duplicate
    * of the instance referred to by TimeLocCommsSignals_var.
    *
    * @param TimeLocCommsSignals_var TimeLocCommsSignals object class instance of which
    * this newly created TimeLocCommsSignals object class instance will be a
    * duplicate
    */
    public TimeLocCommsSignals( TimeLocCommsSignals TimeLocCommsSignals_var ) {
        super( TimeLocCommsSignals_var );

        set_Protocol( TimeLocCommsSignals_var.get_Protocol() );
        set_Value( TimeLocCommsSignals_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof TimeLocCommsSignals ) {
            TimeLocCommsSignals data = (TimeLocCommsSignals)object;
