package org.webgme.guest.physicsengine.rti;
...
/**
* Implements ObjectRoot.TorqueRequestsOv
*/
public class TorqueRequestsOv extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the TorqueRequestsOv object class with default attribute values.
    */
    public TorqueRequestsOv() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the TorqueRequestsOv object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the TorqueRequestsOv object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.TorqueRequestsOv";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the TorqueRequestsOv object class.
    *
    * @return the name of this object class
    */
    public static String get_simple_class_name() {
        return "TorqueRequestsOv";
    }
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.TorqueRequestsOv");
        _classNameClassMap.put("ObjectRoot.TorqueRequestsOv", TorqueRequestsOv.class);

        _datamemberClassNameSetMap.put("ObjectRoot.TorqueRequestsOv", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.TorqueRequestsOv", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.TorqueRequestsOv", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.TorqueRequestsOv", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.TorqueRequestsOv");
        ...
        _classNameHandleMap.put("ObjectRoot.TorqueRequestsOv", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.TorqueRequestsOv");
        _classHandleSimpleNameMap.put(get_handle(), "TorqueRequestsOv");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.TorqueRequestsOv.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.TorqueRequestsOv.Value", _Value_handle);
    ...
    /**
    * Publishes the TorqueRequestsOv object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.TorqueRequestsOv." + attributeName));
    ...
    /**
    * Unpublishes the TorqueRequestsOv object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the TorqueRequestsOv object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.TorqueRequestsOv." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the TorqueRequestsOv object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the TorqueRequestsOv object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the TorqueRequestsOv object class).
    ...
    */
    ...
    protected TorqueRequestsOv( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected TorqueRequestsOv( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the TorqueRequestsOv object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new TorqueRequestsOv object class instance
    */
    public TorqueRequestsOv( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #TorqueRequestsOv( ReflectedAttributes datamemberMap )}, except this
    * new TorqueRequestsOv object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new TorqueRequestsOv object class instance
    * @param logicalTime timestamp for this new TorqueRequestsOv object class
    * instance
    */
    public TorqueRequestsOv( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new TorqueRequestsOv object class instance that is a duplicate
    * of the instance referred to by TorqueRequestsOv_var.
    *
    * @param TorqueRequestsOv_var TorqueRequestsOv object class instance of which
    * this newly created TorqueRequestsOv object class instance will be a
    * duplicate
    */
    public TorqueRequestsOv( TorqueRequestsOv TorqueRequestsOv_var ) {
        super( TorqueRequestsOv_var );

        set_Protocol( TorqueRequestsOv_var.get_Protocol() );
        set_Value( TorqueRequestsOv_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof TorqueRequestsOv ) {
            TorqueRequestsOv data = (TorqueRequestsOv)object;
