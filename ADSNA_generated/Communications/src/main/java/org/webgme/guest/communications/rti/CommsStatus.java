...
/**
* Implements ObjectRoot.CommsStatus
*/
public class CommsStatus extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the CommsStatus object class with default attribute values.
    */
    public CommsStatus() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the CommsStatus object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the CommsStatus object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.CommsStatus";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the CommsStatus object class.
    *
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.CommsStatus");
        _classNameClassMap.put("ObjectRoot.CommsStatus", CommsStatus.class);

        _datamemberClassNameSetMap.put("ObjectRoot.CommsStatus", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.CommsStatus", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.CommsStatus", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.CommsStatus", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.CommsStatus");
        ...
        _classNameHandleMap.put("ObjectRoot.CommsStatus", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.CommsStatus");
        _classHandleSimpleNameMap.put(get_handle(), "CommsStatus");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.CommsStatus.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.CommsStatus.Value", _Value_handle);
    ...
    /**
    * Publishes the CommsStatus object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.CommsStatus." + attributeName));
    ...
    /**
    * Unpublishes the CommsStatus object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the CommsStatus object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.CommsStatus." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the CommsStatus object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the CommsStatus object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the CommsStatus object class).
    ...
    */
    ...
    protected CommsStatus( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected CommsStatus( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the CommsStatus object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new CommsStatus object class instance
    */
    public CommsStatus( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #CommsStatus( ReflectedAttributes datamemberMap )}, except this
    * new CommsStatus object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new CommsStatus object class instance
    * @param logicalTime timestamp for this new CommsStatus object class
    * instance
    */
    public CommsStatus( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new CommsStatus object class instance that is a duplicate
    * of the instance referred to by CommsStatus_var.
    *
    * @param CommsStatus_var CommsStatus object class instance of which
    * this newly created CommsStatus object class instance will be a
    * duplicate
    */
    public CommsStatus( CommsStatus CommsStatus_var ) {
        super( CommsStatus_var );

        set_Protocol( CommsStatus_var.get_Protocol() );
        set_Value( CommsStatus_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof CommsStatus ) {
            CommsStatus data = (CommsStatus)object;
