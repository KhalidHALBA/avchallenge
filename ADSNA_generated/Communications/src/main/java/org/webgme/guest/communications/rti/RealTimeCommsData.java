package org.webgme.guest.communications.rti;
...
/**
* Implements ObjectRoot.RealTimeCommsData
*/
public class RealTimeCommsData extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the RealTimeCommsData object class with default attribute values.
    */
    public RealTimeCommsData() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the RealTimeCommsData object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the RealTimeCommsData object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.RealTimeCommsData";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the RealTimeCommsData object class.
    *
    * @return the name of this object class
    */
    public static String get_simple_class_name() {
        return "RealTimeCommsData";
    }
    ...
    * RealTimeCommsData object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.RealTimeCommsData");
        _classNameClassMap.put("ObjectRoot.RealTimeCommsData", RealTimeCommsData.class);

        _datamemberClassNameSetMap.put("ObjectRoot.RealTimeCommsData", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.RealTimeCommsData", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.RealTimeCommsData", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.RealTimeCommsData", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.RealTimeCommsData");
        ...
        _classNameHandleMap.put("ObjectRoot.RealTimeCommsData", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.RealTimeCommsData");
        _classHandleSimpleNameMap.put(get_handle(), "RealTimeCommsData");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.RealTimeCommsData.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.RealTimeCommsData.Value", _Value_handle);
    ...
    /**
    * Publishes the RealTimeCommsData object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.RealTimeCommsData." + attributeName));
    ...
    /**
    * Unpublishes the RealTimeCommsData object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the RealTimeCommsData object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.RealTimeCommsData." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the RealTimeCommsData object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the RealTimeCommsData object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the RealTimeCommsData object class).
    ...
    */
    ...
    protected RealTimeCommsData( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected RealTimeCommsData( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the RealTimeCommsData object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new RealTimeCommsData object class instance
    */
    public RealTimeCommsData( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #RealTimeCommsData( ReflectedAttributes datamemberMap )}, except this
    * new RealTimeCommsData object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new RealTimeCommsData object class instance
    * @param logicalTime timestamp for this new RealTimeCommsData object class
    * instance
    */
    public RealTimeCommsData( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new RealTimeCommsData object class instance that is a duplicate
    * of the instance referred to by RealTimeCommsData_var.
    *
    * @param RealTimeCommsData_var RealTimeCommsData object class instance of which
    * this newly created RealTimeCommsData object class instance will be a
    * duplicate
    */
    public RealTimeCommsData( RealTimeCommsData RealTimeCommsData_var ) {
        super( RealTimeCommsData_var );

        set_Protocol( RealTimeCommsData_var.get_Protocol() );
        set_Value( RealTimeCommsData_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof RealTimeCommsData ) {
            RealTimeCommsData data = (RealTimeCommsData)object;
