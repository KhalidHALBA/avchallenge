...
/**
* Implements ObjectRoot.SensorData
*/
public class SensorData extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the SensorData object class with default attribute values.
    */
    public SensorData() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the SensorData object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the SensorData object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.SensorData";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the SensorData object class.
    *
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.SensorData");
        _classNameClassMap.put("ObjectRoot.SensorData", SensorData.class);

        _datamemberClassNameSetMap.put("ObjectRoot.SensorData", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.SensorData", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.SensorData", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.SensorData", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.SensorData");
        ...
        _classNameHandleMap.put("ObjectRoot.SensorData", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.SensorData");
        _classHandleSimpleNameMap.put(get_handle(), "SensorData");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.SensorData.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.SensorData.Value", _Value_handle);
    ...
    /**
    * Publishes the SensorData object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.SensorData." + attributeName));
    ...
    /**
    * Unpublishes the SensorData object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the SensorData object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.SensorData." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the SensorData object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the SensorData object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the SensorData object class).
    ...
    */
    ...
    protected SensorData( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected SensorData( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the SensorData object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new SensorData object class instance
    */
    public SensorData( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #SensorData( ReflectedAttributes datamemberMap )}, except this
    * new SensorData object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new SensorData object class instance
    * @param logicalTime timestamp for this new SensorData object class
    * instance
    */
    public SensorData( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new SensorData object class instance that is a duplicate
    * of the instance referred to by SensorData_var.
    *
    * @param SensorData_var SensorData object class instance of which
    * this newly created SensorData object class instance will be a
    * duplicate
    */
    public SensorData( SensorData SensorData_var ) {
        super( SensorData_var );

        set_Protocol( SensorData_var.get_Protocol() );
        set_Value( SensorData_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof SensorData ) {
            SensorData data = (SensorData)object;
