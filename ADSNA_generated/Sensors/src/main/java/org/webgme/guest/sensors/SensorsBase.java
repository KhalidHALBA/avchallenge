...
public class SensorsBase extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public SensorsBase(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
        ...
        // object pubsub
        SensorStatus.publish_Protocol();
        SensorStatus.publish_Value();
        SensorStatus.publish(getLRC());
        SensorData.publish_Protocol();
        SensorData.publish_Value();
        SensorData.publish(getLRC());
    }
