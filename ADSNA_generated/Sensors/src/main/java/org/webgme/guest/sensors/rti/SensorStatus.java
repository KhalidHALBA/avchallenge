package org.webgme.guest.sensors.rti;
...
/**
* Implements ObjectRoot.SensorStatus
*/
public class SensorStatus extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the SensorStatus object class with default attribute values.
    */
    public SensorStatus() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the SensorStatus object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the SensorStatus object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.SensorStatus";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the SensorStatus object class.
    *
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.SensorStatus");
        _classNameClassMap.put("ObjectRoot.SensorStatus", SensorStatus.class);

        _datamemberClassNameSetMap.put("ObjectRoot.SensorStatus", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.SensorStatus", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.SensorStatus", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.SensorStatus", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.SensorStatus");
        ...
        _classNameHandleMap.put("ObjectRoot.SensorStatus", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.SensorStatus");
        _classHandleSimpleNameMap.put(get_handle(), "SensorStatus");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.SensorStatus.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.SensorStatus.Value", _Value_handle);
    ...
    /**
    * Publishes the SensorStatus object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.SensorStatus." + attributeName));
    ...
    /**
    * Unpublishes the SensorStatus object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the SensorStatus object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.SensorStatus." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the SensorStatus object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the SensorStatus object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the SensorStatus object class).
    ...
    */
    ...
    protected SensorStatus( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected SensorStatus( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the SensorStatus object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new SensorStatus object class instance
    */
    public SensorStatus( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #SensorStatus( ReflectedAttributes datamemberMap )}, except this
    * new SensorStatus object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new SensorStatus object class instance
    * @param logicalTime timestamp for this new SensorStatus object class
    * instance
    */
    public SensorStatus( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new SensorStatus object class instance that is a duplicate
    * of the instance referred to by SensorStatus_var.
    *
    * @param SensorStatus_var SensorStatus object class instance of which
    * this newly created SensorStatus object class instance will be a
    * duplicate
    */
    public SensorStatus( SensorStatus SensorStatus_var ) {
        super( SensorStatus_var );

        set_Protocol( SensorStatus_var.get_Protocol() );
        set_Value( SensorStatus_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof SensorStatus ) {
            SensorStatus data = (SensorStatus)object;
