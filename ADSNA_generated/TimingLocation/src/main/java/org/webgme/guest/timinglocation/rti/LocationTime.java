package org.webgme.guest.timinglocation.rti;
...
/**
* Implements ObjectRoot.LocationTime
*/
public class LocationTime extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the LocationTime object class with default attribute values.
    */
    public LocationTime() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the LocationTime object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the LocationTime object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.LocationTime";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the LocationTime object class.
    *
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.LocationTime");
        _classNameClassMap.put("ObjectRoot.LocationTime", LocationTime.class);

        _datamemberClassNameSetMap.put("ObjectRoot.LocationTime", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.LocationTime", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.LocationTime", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.LocationTime", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.LocationTime");
        ...
        _classNameHandleMap.put("ObjectRoot.LocationTime", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.LocationTime");
        _classHandleSimpleNameMap.put(get_handle(), "LocationTime");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.LocationTime.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.LocationTime.Value", _Value_handle);
    ...
    /**
    * Publishes the LocationTime object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.LocationTime." + attributeName));
    ...
    /**
    * Unpublishes the LocationTime object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the LocationTime object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.LocationTime." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the LocationTime object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the LocationTime object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the LocationTime object class).
    ...
    */
    ...
    protected LocationTime( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected LocationTime( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the LocationTime object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new LocationTime object class instance
    */
    public LocationTime( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #LocationTime( ReflectedAttributes datamemberMap )}, except this
    * new LocationTime object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new LocationTime object class instance
    * @param logicalTime timestamp for this new LocationTime object class
    * instance
    */
    public LocationTime( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new LocationTime object class instance that is a duplicate
    * of the instance referred to by LocationTime_var.
    *
    * @param LocationTime_var LocationTime object class instance of which
    * this newly created LocationTime object class instance will be a
    * duplicate
    */
    public LocationTime( LocationTime LocationTime_var ) {
        super( LocationTime_var );

        set_Protocol( LocationTime_var.get_Protocol() );
        set_Value( LocationTime_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof LocationTime ) {
            LocationTime data = (LocationTime)object;
