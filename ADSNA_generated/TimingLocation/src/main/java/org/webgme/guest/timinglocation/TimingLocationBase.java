package org.webgme.guest.timinglocation;

import org.webgme.guest.timinglocation.rti.*;
...
public class TimingLocationBase extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public TimingLocationBase(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
        ...
        // object pubsub
        LocationTime.publish_Protocol();
        LocationTime.publish_Value();
        LocationTime.publish(getLRC());
    }
