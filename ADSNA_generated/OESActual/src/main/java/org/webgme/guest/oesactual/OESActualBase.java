package org.webgme.guest.oesactual;

import org.webgme.guest.oesactual.rti.*;
...
public class OESActualBase extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public OESActualBase(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
        ...
        // object pubsub
        OESActualMessage.publish_Protocol();
        OESActualMessage.publish_Value();
        OESActualMessage.publish(getLRC());
        OESAResvision.subscribe_Protocol();
        OESAResvision.subscribe_Value();
        OESAResvision.subscribe(getLRC());
    }
