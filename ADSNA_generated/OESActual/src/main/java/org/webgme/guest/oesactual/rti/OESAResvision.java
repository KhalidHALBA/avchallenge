...
/**
* Implements ObjectRoot.OESAResvision
*/
public class OESAResvision extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the OESAResvision object class with default attribute values.
    */
    public OESAResvision() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the OESAResvision object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the OESAResvision object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.OESAResvision";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the OESAResvision object class.
    *
    * @return the name of this object class
    */
    public static String get_simple_class_name() {
        return "OESAResvision";
    }
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.OESAResvision");
        _classNameClassMap.put("ObjectRoot.OESAResvision", OESAResvision.class);

        _datamemberClassNameSetMap.put("ObjectRoot.OESAResvision", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.OESAResvision", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.OESAResvision", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.OESAResvision", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.OESAResvision");
        ...
        _classNameHandleMap.put("ObjectRoot.OESAResvision", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.OESAResvision");
        _classHandleSimpleNameMap.put(get_handle(), "OESAResvision");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.OESAResvision.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.OESAResvision.Value", _Value_handle);
    ...
    /**
    * Publishes the OESAResvision object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.OESAResvision." + attributeName));
    ...
    /**
    * Unpublishes the OESAResvision object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the OESAResvision object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.OESAResvision." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the OESAResvision object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the OESAResvision object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the OESAResvision object class).
    ...
    */
    ...
    protected OESAResvision( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected OESAResvision( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the OESAResvision object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new OESAResvision object class instance
    */
    public OESAResvision( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #OESAResvision( ReflectedAttributes datamemberMap )}, except this
    * new OESAResvision object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new OESAResvision object class instance
    * @param logicalTime timestamp for this new OESAResvision object class
    * instance
    */
    public OESAResvision( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new OESAResvision object class instance that is a duplicate
    * of the instance referred to by OESAResvision_var.
    *
    * @param OESAResvision_var OESAResvision object class instance of which
    * this newly created OESAResvision object class instance will be a
    * duplicate
    */
    public OESAResvision( OESAResvision OESAResvision_var ) {
        super( OESAResvision_var );

        set_Protocol( OESAResvision_var.get_Protocol() );
        set_Value( OESAResvision_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof OESAResvision ) {
            OESAResvision data = (OESAResvision)object;
