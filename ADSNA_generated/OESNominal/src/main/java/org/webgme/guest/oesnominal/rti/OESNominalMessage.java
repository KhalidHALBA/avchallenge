package org.webgme.guest.oesnominal.rti;
...
/**
* Implements ObjectRoot.OESNominalMessage
*/
public class OESNominalMessage extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the OESNominalMessage object class with default attribute values.
    */
    public OESNominalMessage() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the OESNominalMessage object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the OESNominalMessage object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.OESNominalMessage";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the OESNominalMessage object class.
    *
    * @return the name of this object class
    */
    public static String get_simple_class_name() {
        return "OESNominalMessage";
    }
    ...
    * OESNominalMessage object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.OESNominalMessage");
        _classNameClassMap.put("ObjectRoot.OESNominalMessage", OESNominalMessage.class);

        _datamemberClassNameSetMap.put("ObjectRoot.OESNominalMessage", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.OESNominalMessage", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.OESNominalMessage", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.OESNominalMessage", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.OESNominalMessage");
        ...
        _classNameHandleMap.put("ObjectRoot.OESNominalMessage", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.OESNominalMessage");
        _classHandleSimpleNameMap.put(get_handle(), "OESNominalMessage");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.OESNominalMessage.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.OESNominalMessage.Value", _Value_handle);
    ...
    /**
    * Publishes the OESNominalMessage object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.OESNominalMessage." + attributeName));
    ...
    /**
    * Unpublishes the OESNominalMessage object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the OESNominalMessage object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.OESNominalMessage." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the OESNominalMessage object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the OESNominalMessage object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the OESNominalMessage object class).
    ...
    */
    ...
    protected OESNominalMessage( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected OESNominalMessage( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the OESNominalMessage object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new OESNominalMessage object class instance
    */
    public OESNominalMessage( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #OESNominalMessage( ReflectedAttributes datamemberMap )}, except this
    * new OESNominalMessage object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new OESNominalMessage object class instance
    * @param logicalTime timestamp for this new OESNominalMessage object class
    * instance
    */
    public OESNominalMessage( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new OESNominalMessage object class instance that is a duplicate
    * of the instance referred to by OESNominalMessage_var.
    *
    * @param OESNominalMessage_var OESNominalMessage object class instance of which
    * this newly created OESNominalMessage object class instance will be a
    * duplicate
    */
    public OESNominalMessage( OESNominalMessage OESNominalMessage_var ) {
        super( OESNominalMessage_var );

        set_Protocol( OESNominalMessage_var.get_Protocol() );
        set_Value( OESNominalMessage_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof OESNominalMessage ) {
            OESNominalMessage data = (OESNominalMessage)object;
