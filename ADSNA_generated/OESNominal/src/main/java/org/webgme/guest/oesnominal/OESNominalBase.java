package org.webgme.guest.oesnominal;

import org.webgme.guest.oesnominal.rti.*;
...
public class OESNominalBase extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public OESNominalBase(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
        ...
        // object pubsub
        OESNominalMessage.publish_Protocol();
        OESNominalMessage.publish_Value();
        OESNominalMessage.publish(getLRC());
        OESNRevision.subscribe_Protocol();
        OESNRevision.subscribe_Value();
        OESNRevision.subscribe(getLRC());
    }
