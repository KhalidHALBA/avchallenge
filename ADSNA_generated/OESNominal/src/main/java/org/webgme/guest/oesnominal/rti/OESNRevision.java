...
/**
* Implements ObjectRoot.OESNRevision
*/
public class OESNRevision extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the OESNRevision object class with default attribute values.
    */
    public OESNRevision() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the OESNRevision object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the OESNRevision object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.OESNRevision";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the OESNRevision object class.
    *
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.OESNRevision");
        _classNameClassMap.put("ObjectRoot.OESNRevision", OESNRevision.class);

        _datamemberClassNameSetMap.put("ObjectRoot.OESNRevision", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.OESNRevision", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.OESNRevision", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.OESNRevision", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.OESNRevision");
        ...
        _classNameHandleMap.put("ObjectRoot.OESNRevision", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.OESNRevision");
        _classHandleSimpleNameMap.put(get_handle(), "OESNRevision");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.OESNRevision.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.OESNRevision.Value", _Value_handle);
    ...
    /**
    * Publishes the OESNRevision object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.OESNRevision." + attributeName));
    ...
    /**
    * Unpublishes the OESNRevision object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the OESNRevision object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.OESNRevision." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the OESNRevision object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the OESNRevision object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the OESNRevision object class).
    ...
    */
    ...
    protected OESNRevision( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected OESNRevision( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the OESNRevision object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new OESNRevision object class instance
    */
    public OESNRevision( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #OESNRevision( ReflectedAttributes datamemberMap )}, except this
    * new OESNRevision object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new OESNRevision object class instance
    * @param logicalTime timestamp for this new OESNRevision object class
    * instance
    */
    public OESNRevision( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new OESNRevision object class instance that is a duplicate
    * of the instance referred to by OESNRevision_var.
    *
    * @param OESNRevision_var OESNRevision object class instance of which
    * this newly created OESNRevision object class instance will be a
    * duplicate
    */
    public OESNRevision( OESNRevision OESNRevision_var ) {
        super( OESNRevision_var );

        set_Protocol( OESNRevision_var.get_Protocol() );
        set_Value( OESNRevision_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof OESNRevision ) {
            OESNRevision data = (OESNRevision)object;
