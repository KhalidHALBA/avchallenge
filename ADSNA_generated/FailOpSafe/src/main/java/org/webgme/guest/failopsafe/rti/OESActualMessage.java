...
/**
* Implements ObjectRoot.OESActualMessage
*/
public class OESActualMessage extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the OESActualMessage object class with default attribute values.
    */
    public OESActualMessage() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the OESActualMessage object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the OESActualMessage object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.OESActualMessage";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the OESActualMessage object class.
    *
    * @return the name of this object class
    */
    public static String get_simple_class_name() {
        return "OESActualMessage";
    }
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.OESActualMessage");
        _classNameClassMap.put("ObjectRoot.OESActualMessage", OESActualMessage.class);

        _datamemberClassNameSetMap.put("ObjectRoot.OESActualMessage", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.OESActualMessage", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.OESActualMessage", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.OESActualMessage", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.OESActualMessage");
        ...
        _classNameHandleMap.put("ObjectRoot.OESActualMessage", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.OESActualMessage");
        _classHandleSimpleNameMap.put(get_handle(), "OESActualMessage");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.OESActualMessage.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.OESActualMessage.Value", _Value_handle);
    ...
    /**
    * Publishes the OESActualMessage object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.OESActualMessage." + attributeName));
    ...
    /**
    * Unpublishes the OESActualMessage object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the OESActualMessage object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.OESActualMessage." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the OESActualMessage object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the OESActualMessage object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the OESActualMessage object class).
    ...
    */
    ...
    protected OESActualMessage( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected OESActualMessage( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the OESActualMessage object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new OESActualMessage object class instance
    */
    public OESActualMessage( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #OESActualMessage( ReflectedAttributes datamemberMap )}, except this
    * new OESActualMessage object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new OESActualMessage object class instance
    * @param logicalTime timestamp for this new OESActualMessage object class
    * instance
    */
    public OESActualMessage( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new OESActualMessage object class instance that is a duplicate
    * of the instance referred to by OESActualMessage_var.
    *
    * @param OESActualMessage_var OESActualMessage object class instance of which
    * this newly created OESActualMessage object class instance will be a
    * duplicate
    */
    public OESActualMessage( OESActualMessage OESActualMessage_var ) {
        super( OESActualMessage_var );

        set_Protocol( OESActualMessage_var.get_Protocol() );
        set_Value( OESActualMessage_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof OESActualMessage ) {
            OESActualMessage data = (OESActualMessage)object;
