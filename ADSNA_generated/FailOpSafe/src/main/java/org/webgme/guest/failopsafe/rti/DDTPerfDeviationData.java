...
/**
* Implements ObjectRoot.DDTPerfDeviationData
*/
public class DDTPerfDeviationData extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the DDTPerfDeviationData object class with default attribute values.
    */
    public DDTPerfDeviationData() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the DDTPerfDeviationData object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the DDTPerfDeviationData object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.DDTPerfDeviationData";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the DDTPerfDeviationData object class.
    *
    * @return the name of this object class
    */
    public static String get_simple_class_name() {
        return "DDTPerfDeviationData";
    }
    ...
    * DDTPerfDeviationData object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.DDTPerfDeviationData");
        _classNameClassMap.put("ObjectRoot.DDTPerfDeviationData", DDTPerfDeviationData.class);

        _datamemberClassNameSetMap.put("ObjectRoot.DDTPerfDeviationData", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.DDTPerfDeviationData", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.DDTPerfDeviationData", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.DDTPerfDeviationData", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.DDTPerfDeviationData");
        ...
        _classNameHandleMap.put("ObjectRoot.DDTPerfDeviationData", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.DDTPerfDeviationData");
        _classHandleSimpleNameMap.put(get_handle(), "DDTPerfDeviationData");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.DDTPerfDeviationData.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.DDTPerfDeviationData.Value", _Value_handle);
    ...
    /**
    * Publishes the DDTPerfDeviationData object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.DDTPerfDeviationData." + attributeName));
    ...
    /**
    * Unpublishes the DDTPerfDeviationData object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the DDTPerfDeviationData object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.DDTPerfDeviationData." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the DDTPerfDeviationData object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the DDTPerfDeviationData object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the DDTPerfDeviationData object class).
    ...
    */
    ...
    protected DDTPerfDeviationData( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected DDTPerfDeviationData( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the DDTPerfDeviationData object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new DDTPerfDeviationData object class instance
    */
    public DDTPerfDeviationData( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #DDTPerfDeviationData( ReflectedAttributes datamemberMap )}, except this
    * new DDTPerfDeviationData object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new DDTPerfDeviationData object class instance
    * @param logicalTime timestamp for this new DDTPerfDeviationData object class
    * instance
    */
    public DDTPerfDeviationData( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new DDTPerfDeviationData object class instance that is a duplicate
    * of the instance referred to by DDTPerfDeviationData_var.
    *
    * @param DDTPerfDeviationData_var DDTPerfDeviationData object class instance of which
    * this newly created DDTPerfDeviationData object class instance will be a
    * duplicate
    */
    public DDTPerfDeviationData( DDTPerfDeviationData DDTPerfDeviationData_var ) {
        super( DDTPerfDeviationData_var );

        set_Protocol( DDTPerfDeviationData_var.get_Protocol() );
        set_Value( DDTPerfDeviationData_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof DDTPerfDeviationData ) {
            DDTPerfDeviationData data = (DDTPerfDeviationData)object;
