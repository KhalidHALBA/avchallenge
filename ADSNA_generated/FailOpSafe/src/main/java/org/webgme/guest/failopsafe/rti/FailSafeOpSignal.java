...
/**
* Implements ObjectRoot.FailSafeOpSignal
*/
public class FailSafeOpSignal extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the FailSafeOpSignal object class with default attribute values.
    */
    public FailSafeOpSignal() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the FailSafeOpSignal object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the FailSafeOpSignal object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.FailSafeOpSignal";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the FailSafeOpSignal object class.
    *
    * @return the name of this object class
    */
    public static String get_simple_class_name() {
        return "FailSafeOpSignal";
    }
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.FailSafeOpSignal");
        _classNameClassMap.put("ObjectRoot.FailSafeOpSignal", FailSafeOpSignal.class);

        _datamemberClassNameSetMap.put("ObjectRoot.FailSafeOpSignal", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.FailSafeOpSignal", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.FailSafeOpSignal", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.FailSafeOpSignal", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.FailSafeOpSignal");
        ...
        _classNameHandleMap.put("ObjectRoot.FailSafeOpSignal", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.FailSafeOpSignal");
        _classHandleSimpleNameMap.put(get_handle(), "FailSafeOpSignal");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.FailSafeOpSignal.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.FailSafeOpSignal.Value", _Value_handle);
    ...
    /**
    * Publishes the FailSafeOpSignal object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.FailSafeOpSignal." + attributeName));
    ...
    /**
    * Unpublishes the FailSafeOpSignal object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the FailSafeOpSignal object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.FailSafeOpSignal." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the FailSafeOpSignal object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the FailSafeOpSignal object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the FailSafeOpSignal object class).
    ...
    */
    ...
    protected FailSafeOpSignal( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected FailSafeOpSignal( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the FailSafeOpSignal object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new FailSafeOpSignal object class instance
    */
    public FailSafeOpSignal( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #FailSafeOpSignal( ReflectedAttributes datamemberMap )}, except this
    * new FailSafeOpSignal object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new FailSafeOpSignal object class instance
    * @param logicalTime timestamp for this new FailSafeOpSignal object class
    * instance
    */
    public FailSafeOpSignal( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new FailSafeOpSignal object class instance that is a duplicate
    * of the instance referred to by FailSafeOpSignal_var.
    *
    * @param FailSafeOpSignal_var FailSafeOpSignal object class instance of which
    * this newly created FailSafeOpSignal object class instance will be a
    * duplicate
    */
    public FailSafeOpSignal( FailSafeOpSignal FailSafeOpSignal_var ) {
        super( FailSafeOpSignal_var );

        set_Protocol( FailSafeOpSignal_var.get_Protocol() );
        set_Value( FailSafeOpSignal_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof FailSafeOpSignal ) {
            FailSafeOpSignal data = (FailSafeOpSignal)object;
