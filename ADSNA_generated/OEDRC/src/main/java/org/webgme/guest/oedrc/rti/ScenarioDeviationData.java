...
/**
* Implements ObjectRoot.ScenarioDeviationData
*/
public class ScenarioDeviationData extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the ScenarioDeviationData object class with default attribute values.
    */
    public ScenarioDeviationData() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the ScenarioDeviationData object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the ScenarioDeviationData object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.ScenarioDeviationData";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the ScenarioDeviationData object class.
    *
    * @return the name of this object class
    */
    public static String get_simple_class_name() {
        return "ScenarioDeviationData";
    }
    ...
    * ScenarioDeviationData object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.ScenarioDeviationData");
        _classNameClassMap.put("ObjectRoot.ScenarioDeviationData", ScenarioDeviationData.class);

        _datamemberClassNameSetMap.put("ObjectRoot.ScenarioDeviationData", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.ScenarioDeviationData", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.ScenarioDeviationData", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.ScenarioDeviationData", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.ScenarioDeviationData");
        ...
        _classNameHandleMap.put("ObjectRoot.ScenarioDeviationData", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.ScenarioDeviationData");
        _classHandleSimpleNameMap.put(get_handle(), "ScenarioDeviationData");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.ScenarioDeviationData.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.ScenarioDeviationData.Value", _Value_handle);
    ...
    /**
    * Publishes the ScenarioDeviationData object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.ScenarioDeviationData." + attributeName));
    ...
    /**
    * Unpublishes the ScenarioDeviationData object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the ScenarioDeviationData object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.ScenarioDeviationData." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the ScenarioDeviationData object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the ScenarioDeviationData object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the ScenarioDeviationData object class).
    ...
    */
    ...
    protected ScenarioDeviationData( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected ScenarioDeviationData( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the ScenarioDeviationData object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new ScenarioDeviationData object class instance
    */
    public ScenarioDeviationData( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #ScenarioDeviationData( ReflectedAttributes datamemberMap )}, except this
    * new ScenarioDeviationData object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new ScenarioDeviationData object class instance
    * @param logicalTime timestamp for this new ScenarioDeviationData object class
    * instance
    */
    public ScenarioDeviationData( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new ScenarioDeviationData object class instance that is a duplicate
    * of the instance referred to by ScenarioDeviationData_var.
    *
    * @param ScenarioDeviationData_var ScenarioDeviationData object class instance of which
    * this newly created ScenarioDeviationData object class instance will be a
    * duplicate
    */
    public ScenarioDeviationData( ScenarioDeviationData ScenarioDeviationData_var ) {
        super( ScenarioDeviationData_var );

        set_Protocol( ScenarioDeviationData_var.get_Protocol() );
        set_Value( ScenarioDeviationData_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof ScenarioDeviationData ) {
            ScenarioDeviationData data = (ScenarioDeviationData)object;
