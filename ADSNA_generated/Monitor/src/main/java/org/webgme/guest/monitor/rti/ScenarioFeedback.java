...
/**
* Implements ObjectRoot.ScenarioFeedback
*/
public class ScenarioFeedback extends ObjectRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the ScenarioFeedback object class with default attribute values.
    */
    public ScenarioFeedback() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the ScenarioFeedback object class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the ScenarioFeedback object class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "ObjectRoot.ScenarioFeedback";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the ScenarioFeedback object class.
    *
    ...
    */
    ...
    static {
        _classNameSet.add("ObjectRoot.ScenarioFeedback");
        _classNameClassMap.put("ObjectRoot.ScenarioFeedback", ScenarioFeedback.class);

        _datamemberClassNameSetMap.put("ObjectRoot.ScenarioFeedback", _datamemberNames);
        _allDatamemberClassNameSetMap.put("ObjectRoot.ScenarioFeedback", _allDatamemberNames);
        ...
        _classNamePublishAttributeNameMap.put("ObjectRoot.ScenarioFeedback", _publishAttributeNameSet);
        _classNameSubscribeAttributeNameMap.put("ObjectRoot.ScenarioFeedback", _subscribeAttributeNameSet);
    }
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getObjectClassHandle("ObjectRoot.ScenarioFeedback");
        ...
        _classNameHandleMap.put("ObjectRoot.ScenarioFeedback", get_handle());
        _classHandleNameMap.put(get_handle(), "ObjectRoot.ScenarioFeedback");
        _classHandleSimpleNameMap.put(get_handle(), "ScenarioFeedback");
        ...
        _datamemberNameHandleMap.put("ObjectRoot.ScenarioFeedback.Protocol", _Protocol_handle);
        _datamemberNameHandleMap.put("ObjectRoot.ScenarioFeedback.Value", _Value_handle);
    ...
    /**
    * Publishes the ScenarioFeedback object class for a federate.
    *
    ...
    */
    public static void publish(RTIambassador rti) {
        ...
        for(String attributeName : _publishAttributeNameSet) {
            try {
                publishedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.ScenarioFeedback." + attributeName));
    ...
    /**
    * Unpublishes the ScenarioFeedback object class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the ScenarioFeedback object class.
    *
    * @param rti handle to the Local RTI Component
    */
    public static void subscribe(RTIambassador rti) {
        ...
        for(String attributeName : _subscribeAttributeNameSet) {
            try {
                subscribedAttributeHandleSet.add(_datamemberNameHandleMap.get("ObjectRoot.ScenarioFeedback." + attributeName));
    ...
    /**
    * Unsubscribes a federate from the ScenarioFeedback object class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the ScenarioFeedback object class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the ScenarioFeedback object class).
    ...
    */
    ...
    protected ScenarioFeedback( ReflectedAttributes datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    protected ScenarioFeedback( ReflectedAttributes datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setAttributes( datamemberMap );
    }

    /**
    * Creates an instance of the ScenarioFeedback object class, using
    * "datamemberMap" to initialize its attribute values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new ScenarioFeedback object class instance
    */
    public ScenarioFeedback( ReflectedAttributes datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #ScenarioFeedback( ReflectedAttributes datamemberMap )}, except this
    * new ScenarioFeedback object class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * attributes of this new ScenarioFeedback object class instance
    * @param logicalTime timestamp for this new ScenarioFeedback object class
    * instance
    */
    public ScenarioFeedback( ReflectedAttributes datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new ScenarioFeedback object class instance that is a duplicate
    * of the instance referred to by ScenarioFeedback_var.
    *
    * @param ScenarioFeedback_var ScenarioFeedback object class instance of which
    * this newly created ScenarioFeedback object class instance will be a
    * duplicate
    */
    public ScenarioFeedback( ScenarioFeedback ScenarioFeedback_var ) {
        super( ScenarioFeedback_var );

        set_Protocol( ScenarioFeedback_var.get_Protocol() );
        set_Value( ScenarioFeedback_var.get_Value() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof ScenarioFeedback ) {
            ScenarioFeedback data = (ScenarioFeedback)object;
