 ...
 */
public class VisualizeAnalyticsConfig extends FederateConfig {
	/**
	...
	// SPNs aggregation : We suppose all SPNs have the same PGN so far, to be
	// modified when the right PGNs are described.
	@FederateParameter
